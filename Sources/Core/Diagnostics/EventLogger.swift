...
public actor EventLogger: EventLogging {
    ...
    public func diagnosticsSummary(currentUpdate: AppRuntimeUpdate?) -> DiagnosticsSummary {
        ...
        return DiagnosticsSummary(
            ...
            helperInstallState: currentUpdate?.capabilityReport.helperInstallStatus?.state,
            helperVersion: currentUpdate?.capabilityReport.helperInstallStatus?.helperVersion,
            helperInstallReason: currentUpdate?.capabilityReport.helperInstallStatus?.reason,
